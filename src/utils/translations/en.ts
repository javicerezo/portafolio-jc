const en = {
  ...
  proyect_paragraph_2: "You won't just see the final result: behind it there are hours of organization, API integrations, well-applied methodologies, and the use of modern technologies like React, Vite, TypeScript, and Kotlin, as well as more established ones like Gulp, JavaScript, or Java.",
  proyect_paragraph_3: "These projects reflect my evolution as a developer, preserving in each the essence and technical decisions I made at the time to showcase my progress transparently.",
  proyect_paragraph_4: "This portfolio is my most complete project: React + Vite + TypeScript, multilingual, real-time data from the GitHub API, and deployed on Netlify. The contact form includes backend validation. Interested in how it’s built? The code is open!.",
