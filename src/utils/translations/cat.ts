const cat = {
  ...
  proyect_paragraph_1_2: "No només veuràs el resultat final: al darrere hi ha hores d'organització, integracions amb APIs, metodologies ben aplicades i l'ús de tecnologies modernes com React, Vite, TypeScript i Kotlin, així com d'altres més consolidades com Gulp, JavaScript o Java.",
  ...
  proyect_paragraph_3_1: "Aquest portafoli és el meu projecte més complet: React + Vite + TypeScript, multilingüe, dades en temps real des de l'API de GitHub i desplegat a Netlify. El formulari de contacte inclou validació en backend. T'interessa saber com està fet? El codi és obert!",
  ...
  tooltip_private_site: "La demostració d'aquesta aplicació no està disponible.",
