const es = {
  ...
  proyect_paragraph_2: "No solo verás el resultado final, detrás hay horas de organización, integración de APIs, metodologías bien aplicadas, y uso de tecnologías modernas como React, Vite y TypeScript, y otras no tan modernas como Gulp o JavaScript.",
  proyect_paragraph_3: "Este portafolio es mi proyecto más completo: React + Vite + TypeScript, multidioma, datos en tiempo real desde la API de GitHub y despliegue en Netlify. El formulario incluye validación en backend. ¿Te interesa saber cómo está hecho? ¡El código está abierto!.",
