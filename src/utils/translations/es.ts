const es = {
  ...
  proyect_paragraph_3: "Estos proyectos reflejan mi evolución como desarrollador, conservando en cada uno la esencia y las decisiones técnicas que tomé en su momento para mostrar mi progreso de forma transparente.",
