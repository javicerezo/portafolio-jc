const es = {
  ...
  proyect_paragraph_1_1: "Cada proyecto aquí representa un reto que me ha ayudado a crecer como desarrollador. Me gusta ir más allá del 'funciona' y cuidar la arquitectura, la optimización y la experiencia de usuario.",
  proyect_paragraph_1_2: "No solo verás el resultado final, detrás hay horas de organización, integraciones con APIs, metodologías bien aplicadas y el uso de tecnologías modernas como React, Vite, TypeScript y Kotlin, así como otras más consolidadas como Gulp, JavaScript o Java.",
  proyect_paragraph_1_3: "Estos proyectos reflejan mi progreso como desarrollador, conservando en cada uno la esencia y las decisiones técnicas que tomé en su momento para mostrar mi evolución.",
  proyect_paragraph_1_4: "Lista de proyectos:",
  proyect_paragraph_2_1: "Versiones originales (stack clásico):",
  proyect_paragraph_2_2: "A continuación agrupo las primeras versiones de algunos proyectos mostrados en la lista anterior. Mismo objetivo y diseño, pero con tecnologías anteriores (JS vanilla, Gulp, etc.). Las mantengo por transparencia y comparación, en varios casos el repositorio está archivado en GitHub (solo lectura).",
  proyect_paragraph_3_1: "Este portafolio es mi proyecto más completo: React + Vite + TypeScript, multidioma, datos en tiempo real desde la API de GitHub y despliegue en Netlify. El formulario incluye validación en backend. ¿Te interesa saber cómo está hecho? ¡El código está abierto!.",
  proyect_paragraph_3_2: "Sobre este portafolio:",
